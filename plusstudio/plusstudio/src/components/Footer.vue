  ...
  <div class="fluid-container footer flex">
    ...
    <div class="row">
      ...
      <div class="col-sm-auto">
        ...
        <a href="https://www.facebook.com/plustudio_photography">Facebook</a>
      </div>
      <div class="col-sm-auto">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="https://instagram.com/plustudiophotography?igshid=YmMyMTA2M2Y=">Instagram</a>
      </div>
      <div class="col-sm-auto">
        ...
        <a href="https://wa.me/5352730980">+5352730980</a>
      </div>
      <div class="col-sm-auto">
        ...
        <a href="https://goo.gl/maps/5RQ2ph3px3LP4sJd8">Ubicación</a>
      </div>
      <div class="col-sm-auto">
        ...
        <a href="mailto:plustudiophotography@gmail.com?subject=Mas%20Informacion">E-mail</a>
      </div>
      <!-- <div class="col-sm-auto">
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row my-2">
      ...
      <div class="col-sm-auto">
        ...
        <a href="#" target="_blank" class="disabled-link">{{ year }}</a>
      </div>
      <div class="col-sm"></div>
    </div>
  </div>
